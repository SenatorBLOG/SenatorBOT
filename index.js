...
bot.help((ctx) => ctx.reply('Открытки можно купить переводом на мой номер +79802510158, в сообщении к переводу укажите страну,город,индекс и точный адрес с квартирой,и конечно же ИМЯ на которое отправить открытку! Стоимость от 250рублей.'));
